    ...
    <section className="text-purple-950 body-font">
      <div className="container px-5 py-24 mx-auto">
        ...
        <div className="flex lg:w-2/3 w-full sm:flex-row flex-col mx-auto px-8 sm:space-x-4 sm:space-y-0 space-y-4 sm:px-0 sm:items-end items-start">
          ...
          <button className="text-white bg-purple-900 font-cinzel font-bold border-0 py-2 px-8 focus:outline-none hover:bg-purple-600 rounded text-lg">
            SUBMIT
          </button>
        </div>
      </div>
    </section>
    <img className="md:w-1/2 w-3/4 h-1/2 drop-shadow-2xl max-md:pb-5" src={`${process.env.basePath}/assets/Lastsec_image.png`}/>
    </div>
