...
const Lavendar = (props) => {
  ...
  return (
    <div
      className="CanvasDiv max-md:absolute max-md:flex max-md:flex-col max-md:items-start fixed max-md:mt-[-4] md:top-[50%] md:translate-y-[-50%] left-[50%] translate-x-[-50%] z-20 pointer-events-none h-screen w-screen"
      ref={canvasDivRef}
    >
      <Canvas
        shadows
