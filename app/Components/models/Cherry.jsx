...
export function Cherry(props) {
  const { nodes, materials } = useGLTF(`${process.env.NEXT_PUBLIC_BASE_PATH || ''}/assets/3d-model/cherry.glb`)
  return (
...
useGLTF.preload(`${process.env.NEXT_PUBLIC_BASE_PATH || ''}/assets/3d-model/cherry.glb`)